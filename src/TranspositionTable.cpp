...
void TranspositionTable::save(uint64_t key, Move move, double evaluation, int depth, int alpha, int beta, Flags flags)
{
	TTEntry newEntry = {key, move, evaluation, depth, alpha, beta, flags};
